...
class NextVladModel(nn.Module):
    ...
    def forward(self, video_feature, text_input_ids, text_mask, target):
        ...
        if target is not None:
            ...
            # print("tagLossAll",taglossAll)
            # print("targetText",targetText)
            # print("targetVideo",targetVideo)
#             tagLossAll tensor(0.6681, device='cuda:0')
#             targetText tensor(0.6980, device='cuda:0')
#             targetVideo tensor(0.6917, device='cuda:0')
